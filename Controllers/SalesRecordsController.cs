...
namespace projeto_final.Controllers
{
    public class SalesRecordsController : Controller
    {
        ...
        {
            var myDbContext = _context.SalesRecord.Include(s => s.Seller).Include(s => s.Status);
        ...
        public async Task<IActionResult> Create([Bind("Id,Date,Amount,StatusId,SellerId")] SalesRecord salesRecord)
        {
            ...
            ViewData["SellerId"] = new SelectList(_context.Seller, "Id", "Id", salesRecord.SellerId);
            ViewData["StatusId"] = new SelectList(_context.Status, "Id", "Id", salesRecord.StatusId);
            return View(salesRecord);
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["StatusId"] = new SelectList(_context.Status, "Id", "Name", salesRecord.StatusId);
            return View(salesRecord);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Date,Amount,StatusId,SellerId")] SalesRecord salesRecord)
        {
